								...
								<div class="card">
									...
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Ajouter un sous_traitant</h3>
										</div>
										<hr>
										<form action="../AddSousTraitants" method="post"
											novalidate="novalidate">
											<div class="form-group">
												<label for="nomETP" class="control-label mb-1">Nom d'entreprise</label> <input id="nomETP" name="nomETP"
													type="text" class="form-control" aria-required="true"
													aria-invalid="false" >
											</div>
											<div class="form-group has-success">
												<label for="nomRessponsable" class="control-label mb-1">Nom de Ressonsable</label> <input id="nomRessponsable" name="nomRessponsable" type="text"
													class="form-control cc-name valid">
												<span class="help-block field-validation-valid"
													data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
											</div>
											<div class="form-group">
												<label for="contactRessEtp" class="control-label mb-1">contact de ressponsable d'entreprise</label> <input id="contactRessEtp" name="contactRessEtp" type="text"
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="ResponsableDeTraveaux" class="control-label mb-1">Ressponsable du traveaux</label>
														<input id="ResponsableDeTraveaux" name="ResponsableDeTraveaux" type="text"
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="contactResspTraveaux" class="control-label mb-1">contact de Ressponsable du traveaux</label>
														<input id="contactResspTraveaux" name="contactResspTraveaux" type="text"
															class="form-control cc-exp" > <span
															class="help-block" data-valmsg-for="cc-exp"
															data-valmsg-replace="true"></span>
													</div>
