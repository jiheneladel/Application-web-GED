								...
								<div class="card">
									...
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Controler un Extincteur
											</h3>
										</div>
										<hr>
										<form action="../ContrlerExtincteur" method="post"
											...
											<div class="form-group">
												<label for="codeEXT" class="control-label mb-1">Code
													Extincteur</label> <input readonly id="codeEXT" name="codeEXT"
													type="text" class="form-control" aria-required="true"
													aria-invalid="false" value="<%=code %>">
											</div>
											<div class="form-group has-success">
												<label for="type" class="control-label mb-1">Ressponsable</label>
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														...
														<input id="date" name="date" type="date" value="<%=dte%>"
											...
											<div class="form-group">
												<label for="observation" class="control-label mb-1">observation</label>
											...
											<div>
												<button id="payment-button" type="submit"
													class="btn btn-lg btn-info btn-block">Controler
													Extincteur</button>
											</div>
										</form>
									</div>
