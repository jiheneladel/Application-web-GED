							...
							<div class="col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										...
										<hr>
										<form role="form" action="../UpdateRapportVisite"
											method="post">
											<%
												int id = Integer.parseInt(request.getParameter("ID"));
												RapportDeVisit rv = RapportDeVisitDAO.getRapportDeVisitByCode(id);
											%>
											...
											<div class="form-group">
												<label for="1234"> zone: </label> <input type="text"
													class="form-control" id="zone" name="zone"
													value="<%=rv.getZone()%>">
											</div>
											<div class="form-group">
												<label for="1234"> Activite: </label> <input type="text"
													class="form-control" id="Activite" name="Activite"
													value="<%=rv.getActivite()%>">
											</div>
											<div class="form-group">
												<label for="1234"> tache: </label> <input type="text"
													class="form-control" id="tache" name="tache"
													value="<%=rv.getTache()%>">
											</div>
											<div class="form-group">
