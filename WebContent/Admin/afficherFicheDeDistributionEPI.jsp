<%@page import="com.pfe.Utils.GetEPI"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.pfe.DAO.FicheDeDistributionEPIDAO"%>
<%@page import="com.pfe.Models.FicheDeDistributionEPI"%>
											...
											<tr>
												<form method="post">
													<div class="form-group">
														<label for="codeRIA" class="control-label mb-1">Date
															debut</label> <input type="date" class="form-control" name=debut>
														<label for="codeRIA" class="control-label mb-1">Date
															Fin</label> <input type="date" class="form-control" name=fin>
														<label for="codeRIA" class="control-label mb-1">Etat</label>
														<input type="number" class="form-control" name=etat>
													</div>
													<button id="sub" type="submit"
														class="btn btn-lg btn-info btn-block">Filtrer</button>
												</form>
											</tr>
											<tr>
												<th>Nom d'utilsateur</th>
												<th>Fonction</th>
												<th>Date a prendre</th>
												<th>EPI a prendre</th>
												<th>Acquitter</th>
												<th><a class="btn btn-success"
													href="AddFicheDeDistributionEPI.jsp">Ajouter</a></th>
											</tr>
										</thead>
										<tbody>
											<%
												...
												int etat = -1;
												if (request.getParameter("etat") != "" && request.getParameter("etat") !=null) {
													etat = Integer.parseInt(request.getParameter("etat"));
												}
												ArrayList<FicheDeDistributionEPI> ex = GetEPI.getByFilter(datedebut, datefin, etat);
												for (FicheDeDistributionEPI e : ex) {
											%>
											<tr>
												<td><%=e.getNomUtilisateur()%></td>
												<td><%=e.getFonction()%></td>
												<td><%=e.getDateAprendre()%></td>
												<td><%=e.getEPIaPrendre()%></td>
												<td><%=e.isAcquitter()%></td>

												<td style='white-space: nowrap'><a
													class="btn btn-outline-info block" href=""> Modifier </a> <a
													class="btn btn-outline-danger block"
													href="../supprimerFicheDeDistributionEP?code=<%=e.getId()%>">
														Supprimer </a></td>
											</tr>
											<%
												}
