<%@page import="com.pfe.Models.SousTraitants"%>
<%@page import="com.pfe.DAO.SousTraitantsDAO"%>
			...
			<div class="menu-sidebar__content js-scrollbar1">
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						...
						<li class="active"><a href="form.html"> <i
				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-header">Sous_Traitants</div>
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Modifier</h3>
										</div>
										<hr>
										<form role="form" action="../UpdateSousTraitants"
											method="post">
											<%
												int idST = Integer.parseInt(request.getParameter("ID"));
											SousTraitants rv = SousTraitantsDAO.getSousTraitantsByCode(idST);
											%>
											<div class="form-group">
												<label for="idST"> Id: </label> <input readonly
													type="text" class="form-control" id="idST"
													name="idST" value="<%=rv.getIdST()%>" />
											</div>
											<div class="form-group">
												<label for="nomETP"> Nom de l'entreprise: </label> <input
													type="text" class="form-control" id="nomETP"
													name="nomETP" value="<%=rv.getNomETP()%>"/>
											</div>
											<div class="form-group">
												<label for="nomRessponsable"> nom de responsable: </label> <input type="text"
													class="form-control" id="nomRessponsable" name="nomRessponsable"
													value="<%=rv.getNomRessponsable()%>">
											</div>
											<div class="form-group">
												<label for="ontactRessEtp"> contact de responsable d'entreprise: </label> <input type="text"
													class="form-control" id="contactRessEtp" name="contactRessEtp"
													value="<%=rv.getContactRessEtp()%>">
											</div>
											<div class="form-group">
												<label for="ResponsableDeTraveaux" > Ressponsable de travaux: </label> <input type="text"
													class="form-control" id="ResponsableDeTraveaux" name="ResponsableDeTraveaux"
													value="<%=rv.getResponsableDeTraveaux()%>">
											</div>
											<div class="form-group">
												<label for="contactResspTraveaux"> contact de responsable de travaux: </label> <input type="text"
													class="form-control" id="contactResspTraveaux" name="contactResspTraveaux"
													value="<%=rv.getContactResspTraveaux()%>">
											</div>
