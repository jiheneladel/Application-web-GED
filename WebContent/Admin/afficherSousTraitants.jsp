 K<%@page import="java.util.ArrayList"%>
									...
									<table class="table table-borderless table-data3">
										<thead>
											<tr>
												...
												<th>Nom de Ressonsable</th>
												<th>contact de ressponsable d'entreprise</th>
												<th>Ressponsable du traveaux</th>
												<th>contact de Ressponsable du traveaux</th>
												<th><a class="btn btn-success" href="AddSousTraitants.jsp">Ajouter</a></th>
											</tr>
										</thead>
										<tbody>
											<%
												ArrayList<SousTraitants> ex = SousTraitantsDAO.getAll();
												for (SousTraitants e : ex) {
											%>
											<tr>
												<td><%=e.getNomETP()%></td>
												<td><%=e.getNomRessponsable()%></td>
												<td><%=e.getContactRessEtp()%></td>
												<td><%=e.getResponsableDeTraveaux()%></td>
												<td><%=e.getContactResspTraveaux()%></td>
												

												<td style='white-space: nowrap'><a
													class="btn btn-outline-info block" href="UpdateSousTraitants.jsp?ID=<%=e.getIdST()%>"> Modifier </a> <a
													class="btn btn-outline-danger block"
													href="../DeleteSousTrt?ID=<%=e.getIdST()%>">
														Supprimer </a></td>
											</tr>
											<%
												}
