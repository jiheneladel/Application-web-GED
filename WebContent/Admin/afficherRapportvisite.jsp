							...
							<div class="col-md-12">
								...
								<div class="table-responsive m-b-40">
									<table class="table table-borderless table-data3">
										...
										<tbody>
											<%
												ArrayList<RapportDeVisit> ex = RapportDeVisitDAO.getAll();
												for (RapportDeVisit e : ex) {
											%>
											<tr>
												...
												<td style='white-space: nowrap'><a
													class="btn btn-outline-info block" href="UpdateRapportVisite.jsp?ID=<%=e.getId()%>"> Modifier </a> <a
													class="btn btn-outline-danger block"
													href="../SupprimerRapportVisite?code=<%=e.getId()%>">
														Supprimer </a></td>
											</tr>
											<%
												}
