	...
	<div class="page-wrapper">
		...
		<div class="page-container">
				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-header">Rapport d'urgence</div>
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Ajouter un Rapport d'urgence</h3>
										</div>
										<hr>
										<form action="../AddRapportDurgence" method="post"
											novalidate="novalidate">
											
			<%
			ArrayList<Action> A = ActionDAO.getAll();
			Date lyoum = new Date();
			...
			<div class="form-group">
												<label for="id_action" class="control-label mb-1">ID
													Action: </label> <select id="id_action" name="id_action"
													class="form-control" aria-required="true">
													<%
														for (Action e : A) {
													%>
													<option value="<%=e.getID_Action()%>"><%=e.getNomAction()%></option>
													<%
														}
													%>
												</select>
											...
											<div class="form-group has-success">
												<label for="type" class="control-label mb-1">type:
												</label> <input id="type" name="type" type="text"
											...
											<div class="form-group">
												<label for="local" class="control-label mb-1">local: 
												</label> <input id="local" name="local" type="text"
											...
											<div class="form-group">
												<label for="acteurs" class="control-label mb-1">
												acteurs: 
												</label> <input id="acteurs" name="acteurs" type="text"
													class="form-control cc-number identified visa"> <span class="help-block"
													data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
											</div>
											<div class="form-group">
