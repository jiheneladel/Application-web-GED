...
<%@page import="com.pfe.Models.Action"%>
									...
									<table class="table table-borderless table-data3">
										<thead>
											<tr>
												...
												<th><a class="btn btn-success" href="AddAction.jsp">Ajouter un Action</a></th>
											</tr>
										</thead>
										<tbody>
											<%
												ArrayList<Action> ex = ActionDAO.getAll();
												for (Action e : ex) {
											%>
											<tr>
												<td><%=e.getNomAction()%></td>
												<td><%=e.getSource()%></td>
												<td><%=e.getDescription()%></td>
												<td><%=e.getRessponsable()%></td>
												<td><%=e.getDelai()%></td>
												<td><%=e.getDateRealisation()%></td>

												<td style='white-space: nowrap'><a
													class="btn btn-outline-info block" href=""> Modifier </a> <a
													class="btn btn-outline-danger block"
													href="../SupprimerAction?code=<%=e.getID_Action()%>">
														Supprimer </a></td>
											</tr>
											<%
												}
