				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-header">Rapport d'accident</div>
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Ajouter un Rapport
												d'accident</h3>
										</div>
										<hr>
										<form action="../AddRapportAccident" method="post"
											novalidate="novalidate">

											<%
											ArrayList<Action> A = ActionDAO.getAll();
												RapportAccident rdv = (RapportAccident) request.getAttribute(" RapportAccident");
												Date lyoum = new Date();
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														...
														</label> <input id="date" name="date" type="date"
															value="<%=dte%>" class="form-control cc-exp">
											...
											<div class="form-group has-success">
												<label for="description" class="control-label mb-1">description
												</label> <input id="description" name="description" type="text"
													class="form-control cc-name valid"> <span
													class="help-block field-validation-valid"
													data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
											</div>

											<div class="form-group">
												<label for="causeAccident" class="control-label mb-1">cause
													d'accident </label> <input id="causeAccident" name="causeAccident"
											...
											<div class="form-group">
												<label for="idEmploye" class="control-label mb-1">Employer
												</label> <input id="idEmploye" name="idEmployer" type="text" min=8 max=11
													class="form-control" aria-required="true"
													aria-invalid="false">
											</div>
