								...
								<div class="card">
									...
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Ajouter un Rapport du
												visite</h3>
										</div>
										<hr>
										<form action="../AddRapportVisit" method="post"
											...
											<div class="form-group has-success">
												<label for="Activite" class="control-label mb-1">Activite:
												</label> <input id="Activite" name="Activite" type="text"
													class="form-control cc-name valid"> <span
													class="help-block field-validation-valid"
													data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
											</div>
											<div class="form-group">
												<label for="tache" class="control-label mb-1">tache:
												</label> <input id="tache" name="tache" type="text"
													class="form-control cc-number identified visa"> <span
													class="help-block" data-valmsg-for="cc-number"
