								...
								<div class="card">
									...
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Ajouter un Action</h3>
										</div>
										<hr>
										<form action="../AddAction" method="post"
											...
											<div class="form-group">
												...
												<label for="nomAction" class="control-label mb-1">Nom Action</label> <input id="nomAction" name="nomAction"
													type="text" class="form-control" aria-required="true"
													aria-invalid="false" >
											</div>
											<div class="form-group has-success">
												<label for="source" class="control-label mb-1">Source</label> <input id="source" name="source" type="text"
											...
											<div class="form-group">
												<label for="Ressponsable" class="control-label mb-1">Ressponsable</label> <input id="Ressponsable" name="Ressponsable" type="text"
													class="form-control cc-number identified visa"> <span class="help-block"
													data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
											</div>
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="Ressponsable" class="control-label mb-1">Delai</label>
														<input id="date" name="Delai" type="date"
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="Ressponsable" class="control-label mb-1">Date Realisation</label>
														<input id="date" name="DateRealisation" type="date"
															class="form-control cc-exp"> <span
															class="help-block" data-valmsg-for="cc-exp"
															data-valmsg-replace="true"></span>
													</div>
