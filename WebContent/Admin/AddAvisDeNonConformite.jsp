...
<%@page import="com.pfe.Models.Extincteur"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	  <%@ page import="com.pfe.Models.*"%>
	    <%@ page import="com.pfe.DAO.*"%>
		...
		<div class="page-container">
				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-header">Avis de non-conformite</div>
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Ajouter un AVIS</h3>
										</div>
										<hr>
										<form action="../AddAvisDeNonConformite" method="post"
			...
			%>
											...
											<div class="form-group has-success">
												<label for="Travailleur" class="control-label mb-1">
												Travailleur
												</label> <input id="Travailleur" name="Travailleur" type="text"
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="date" class="control-label mb-1">Date: 
														</label>
														<input id="date" name="date" type="date"  value="<%out.print(dte);%>"
															class="form-control cc-exp" > <span
											...
											<div class="form-group">
												<label for="Entreprise" class="control-label mb-1">
												 Entreprise: 
												</label> <input id=" Entreprise" name=" Entreprise" type="text"
													class="form-control cc-number identified visa"> <span class="help-block"
											...
											<div class="form-group">
												<label for="ressponsable" class="control-label mb-1">
												ressponsable: 
												</label> <input id="ressponsable" name="ressponsable" type="text"
													class="form-control cc-number identified visa"> <span class="help-block"
													data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
											</div>
											<div class="form-group">
												<label for="Service" class="control-label mb-1">
												Service: 
												</label> <input id="Service" name="Service" type="text"
													class="form-control cc-number identified visa"> <span class="help-block"
													data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
											</div>
											<div class="form-group">
												<label for="Discription" class="control-label mb-1">
												 Discription: 
												</label> <input id="Discription" name="Discription" type="text"
													class="form-control cc-number identified visa"> <span class="help-block"
													data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
											</div>
											
												<div class="form-group">
												<label for="MesureAprendre" class="control-label mb-1">
												MesureAprendre: 
												</label> <input id="DisMesureAprendre" name="MesureAprendre" type="text"
													class="form-control cc-number identified visa"> <span class="help-block"
													data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
											</div>
											...
											<div>
												<button id="payment-button" type="submit"
													class="btn btn-lg btn-info btn-block">Ajouter
												</button>
											</div>
										</form>
									</div>
