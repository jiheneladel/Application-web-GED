...
<%@page import="com.pfe.DAO.RapportAccidentDAO"%>
<%@page import="com.pfe.Models.RapportAccident"%>
<%@page import="com.pfe.Models.RapportDeVisit"%>
<%@page import="com.pfe.DAO.RapportDeVisitDAO"%>
				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-header">Rapport de visite</div>
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Modifier</h3>
										</div>
										<hr>
										<form role="form" action="../updateRapportAccident"
											method="post">
											<%
												int id = Integer.parseInt(request.getParameter("ID"));
												RapportAccident ra=RapportAccidentDAO.getRapportAccidentByCode(id);
												Employer E=EmployerDAO.getEmployerByID(ra.getIdEmployer());
											%>
											<div class="form-group">
												<label for="1234"> Id: </label> <input readonly
													type="text" class="form-control" id="id"
													name="id" value="<%=ra.getId()%>" />
											</div>
											<div class="form-group">
												<label for="1234"> ID_Action: </label> <input
													type="text" class="form-control" id="id_action"
													name="id_action" value="<%=ra.getID_Action()%>" />
											</div>
											<div class="form-group">
												<label for="1234"> Employée CIN/Passport: </label> <input type="text"
													class="form-control" id="cin" name="cin"
													value="<%=E.getCin()%>">
											</div>
											<div class="form-group">
												<label for="1234">Cause Accident : </label> <input type="text"
													class="form-control" id="causeAccident" name="causeAccident"
													value="<%=ra.getCauseAccident()%>">
											</div>
											<div class="form-group">
												<label for="1234"> date: </label> <input type="date"
													class="form-control" id="date" name="date"
													value="<%=ra.getDate()%>">
											</div>
											<div class="form-group">
												<label for="1234"> Description: </label> <input type="text"
													class="form-control" id="Description" name="Description"
													value="<%=ra.getDescription()%>">
											</div>
