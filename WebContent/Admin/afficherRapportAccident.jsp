 K<%@page import="com.pfe.DAO.EmployerDAO"%>
									...
									<table class="table table-borderless table-data3">
										<thead>
											<tr>
												...
												<th>Date</th>
												<th>Description</th>
												<th>cause d'accident</th>
												<th>Employer</th>
											
												<th><a class="btn btn-success" href="AddRapportVisit.jsp">Ajouter</a></th>
											</tr>
										</thead>
										<tbody>
											<%
												ArrayList<RapportAccident> ex =  RapportAccidentDAO.getAll();
												for ( RapportAccident e : ex) {
													Employer em=EmployerDAO.getEmployerByID(e.getIdEmployer());
											%>
											<tr>
												<td><%=e.getID_Action()%></td>
												<td><%=e.getDate()%></td>
												<td><%=e.getDescription()%></td>
												<td><%=e.getCauseAccident()%></td>
												<td><%=em.getNom()%> <%=em.getPrenom() %></td>
												<td style='white-space: nowrap'><a
													class="btn btn-outline-info block" href="UpdateRapportAccident.jsp?ID=<%=e.getId()%>"> Modifier </a> <a
													class="btn btn-outline-danger block"
													href="../supprimerRapportAccident?code=<%=e.getId()%>">
														Supprimer </a></td>
											</tr>
											<%
												}
