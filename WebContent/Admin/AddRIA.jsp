				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-header">RIA</div>
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Ajouter un RIA</h3>
										</div>
										<hr>
										<form action="../AddRIA" method="post"
											novalidate="novalidate">
											<div class="form-group">
												<label for="codeRIA" class="control-label mb-1">Code
													RIA</label> <input id="codeRIA" name="codeRIA"
													type="text" class="form-control" aria-required="true"
													aria-invalid="false" >
											</div>
											<div class="form-group has-success">
												<label for="type" class="control-label mb-1">Type RIA</label> <input id="type" name="type" type="text"
													class="form-control cc-name valid">
												<span class="help-block field-validation-valid"
													data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
											</div>
											<div class="form-group">
												<label for="localisation" class="control-label mb-1">Localisation de RIA</label> <input id="localisation" name="localisation" type="tel"
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="poid" class="control-label mb-1">longuer de RIA</label>
														<input id="longueur" name="longueur" type="text"
