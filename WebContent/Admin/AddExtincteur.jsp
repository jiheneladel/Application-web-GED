								...
								<div class="card">
									...
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Ajouter un Extincteur</h3>
										</div>
										<hr>
										<form action="../AddExtincteur" method="post"
											novalidate="novalidate">
											<div class="form-group">
												<label for="codeEXT" class="control-label mb-1">Code
													Extincteur</label> <input id="codeEXT" name="codeEXT"
													type="text" class="form-control" aria-required="true"
													aria-invalid="false" >
											</div>
											<div class="form-group has-success">
												<label for="type" class="control-label mb-1">Type Extincteur</label> <input id="type" name="type" type="text"
													class="form-control cc-name valid">
												<span class="help-block field-validation-valid"
													data-valmsg-for="cc-name" data-valmsg-replace="true"></span>
											</div>
											<div class="form-group">
												<label for="localisation" class="control-label mb-1">Localisation</label> <input id="localisation" name="localisation" type="tel"
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="poid" class="control-label mb-1">Poid (En Kg)</label>
														<input id="poid" name="poid" type="text"
