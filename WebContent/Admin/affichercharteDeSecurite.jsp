...
<%@page import="com.pfe.DAO.charteDeSecuriteDAO"%>
<%@page import="com.pfe.Models.charteDeSecurite"%>
									...
									<table class="table table-borderless table-data3">
										<thead>
											<tr>
												...
												<th>date Sortie</th>
												<th>responsable</th>
												<th><a class="btn btn-success" href="AddcharteDeSecurite.jsp">Ajouter</a></th>
											</tr>
										</thead>
										<tbody>
											<%
												ArrayList<charteDeSecurite> ex = charteDeSecuriteDAO.getAll();
												for (charteDeSecurite e : ex) {
											%>
											<tr>
												<td><%=e.getDescription()%></td>
												<td><%=e.getLieu_Intervention()%></td>
												<td><%=e.getDateEnter()%></td>
												<td><%=e.getDateSortie()%></td>
												<td><%=e.getResponsable()%></td>
												

												<td style='white-space: nowrap'><a
													class="btn btn-outline-info block" href="UpdateSousTraitants.jsp?ID=<%=e.getId()%>"> Modifier </a> <a
													class="btn btn-outline-danger block"
													href="../DeleteSousTrt?ID=<%=e.getId()%>">
														Supprimer </a></td>
											</tr>
											<%
												}
