...
<%@page import="com.pfe.DAO.ActionDAO"%>
				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-header">Charte de securité</div>
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Ajouter un charte de securité</h3>
										</div>
										<hr>
										<form action="../AddcharteDeSecurite" method="post"
											...
											<div class="form-group">
												<label for="description" class="control-label mb-1">description</label> <input id="description" name="description" type="text"
											...
											<div class="form-group">
												<label for="Lieu_Intervention" class="control-label mb-1">Lieu_Intervention</label> <input id="Lieu_Intervention" name="Lieu_Intervention" type="text"
													class="form-control cc-number identified visa"> <span class="help-block"
													data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
											</div>
											<div class="form-group">
												<label for="dateEnter" class="control-label mb-1">date d'enter</label> <input id="dateEnter" name="dateEnter" type="date"
													value="<%out.print(dte);%>" class="form-control cc-exp"> <span class="help-block"
													data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
											</div>
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="date" class="control-label mb-1"> date Sortie:
														</label> <input id="dateSortie" name=" dateSortie" type="date"
															value="<%out.print(dte);%>" class="form-control cc-exp">
											...
											<div class="form-group">
												<label for="responsable" class="control-label mb-1">responsable</label> <input id="responsable" name="responsable" type="text"
													class="form-control cc-number identified visa"> <span class="help-block"
													data-valmsg-for="cc-number" data-valmsg-replace="true"></span>
											</div>
											...
											<div>
												<button id="payment-button" type="submit"
													class="btn btn-lg btn-info btn-block">Ajouter</button>
											</div>
										</form>
									</div>
								</div>
