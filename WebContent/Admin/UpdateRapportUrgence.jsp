<%@page import="com.pfe.DAO.RapportDurgenceDAO"%>
<%@page import="com.pfe.Models.RapportDurgence"%>
							...
							<div class="col-lg-6">
								<div class="card">
									...
									<div class="card-body">
										...
										<hr>
										<form role="form" action="../UpdateRapportUrgence"
											method="post">
											<%
												int id = Integer.parseInt(request.getParameter("ID"));
												RapportDurgence rv = RapportDurgenceDAO.getRapportDeVisitByCode(id);
											%>
											<div class="form-group">
												 <input hidden="hidden"
													type="text" class="form-control" id="id"
													name="id" value="<%=rv.getId()%>" />
											</div>
											<div class="form-group">
												<label for="1234"> ID_Action: </label> <input
													type="text" class="form-control" id="id_action"
													name="id_action" value="<%=rv.getID_Action()%>" />
											</div>
											<div class="form-group">
												<label for="1234"> Type: </label> <input type="text"
											...
											<div class="form-group">
												<label for="1234"> Local: </label> <input type="text"
													class="form-control" id="local" name="local"
													value="<%=rv.getLocal()%>">
											</div>
											<div class="form-group">
												<label for="1234"> Responsable: </label> <input type="text"
													class="form-control" id="responsable" name="responsable"
													value="<%=rv.getRessponsable()%>">
											</div>
											<div class="form-group">
												<label for="1234"> Acteur: </label> <input type="text"
													class="form-control" id="Acteur" name="Acteur"
													value="<%=rv.getActeurs()%>">
											</div>
											<div class="form-group">
												<label for="1234"> Description: </label> <input type="text"
													class="form-control" id="Description" name="Description"
													value="<%=rv.getDescription()%>">
											</div>
