				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-header">Fiche de distribution des EPI</div>
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Ajouter une fiche</h3>
										</div>
										<hr>
										<form action="../AddFicheDeDistributionEPI" method="post"
											...
											<div class="form-group">
												<label for="nomUtilisateur" class="control-label mb-1">Nom d'utilsateur: 
												</label> <input id="nomUtilisateur" name="nomUtilisateur"
													type="text" class="form-control" aria-required="true"
													aria-invalid="false" >
											</div>
											<div class="form-group has-success">
												<label for="fonction" class="control-label mb-1">Fonction:
												</label> <input id="fonction" name="fonction" type="text"
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="dateAprendre" class="control-label mb-1">Date a prendre: 
														</label>
														<%
					DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
					Date dateAprendre = new Date();
					String dte = dateFormat.format(dateAprendre);
					%>
														<input id="dateAprendre" name="dateAprendre" type="date"  value="<%out.print(dte);%>"
											...
											<div class="row">
												<div class="col-6">
													<div class="form-group">
														<label for="EPIaPrendre" class="control-label mb-1">EPI a prendre:</label>
														<input id="EPIaPrendre" name="EPIaPrendre" type="text"
															class="form-control cc-exp" > <span
															class="help-block" data-valmsg-for="cc-exp"
															data-valmsg-replace="true"></span>
													</div>
