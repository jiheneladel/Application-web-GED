...
<%@page import="com.pfe.DAO.ExtincteurDAO"%>
				...
				<div class="section__content section__content--p30">
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-6">
								<div class="card">
									<div class="card-header">Extincteur</div>
									<div class="card-body">
										<div class="card-title">
											<h3 class="text-center title-2">Modifier</h3>
										</div>
										<hr>
										<form role="form" action="../UpdateEXT" method="post">
					<%
					String code = request.getParameter("ID");
						Extincteur ext = ExtincteurDAO.getExtincteurByCode(code);
					%>

					<div class="form-group">
						<label for="codeEXT"> Code de l'extincteur: </label> <input readonly
							type="text" class="form-control" id="codeEXT" name="codeEXT"
							value="<%out.print(ext.getCodeEXT());%>" />
					</div>
					<div class="form-group">
						<label for="type"> Type de l'extincteur: </label> <input
							type="text" class="form-control" id="type" name="type"
							value="<%out.print(ext.getType());%>">
					</div>
					<div class="form-group">
						<label for="localisation"> Localisation de l'extincteur: </label> <input
							type="text" class="form-control" id="localisation"
							name="localisation" value="<%out.print(ext.getLocalisation());%>">
					</div>
					<div class="form-group">
						<label for="poid"> Poid de l'extincteur: </label> <input
							type="text" class="form-control" id="poid" name="poid"
							value="<%out.print(ext.getPoid());%>">
					</div>
