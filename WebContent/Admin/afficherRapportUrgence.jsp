									...
									<table class="table table-borderless table-data3">
										<thead>
											<tr>
												...
												<th>acteurs</th>
												<th>description</th>
												<th><a class="btn btn-success" href="AddRapportDurgence.jsp">Ajouter</a></th>
											</tr>
										</thead>
										<tbody>
											<%
												ArrayList<RapportDurgence> ex = RapportDurgenceDAO.getAll();
												for (RapportDurgence e : ex) {
											%>
											<tr>
												...
												<td><%=e.getDate()%></td>
												<td><%=e.getLocal()%></td>
												<td><%=e.getRessponsable()%></td>
												<td><%=e.getActeurs()%></td>
												<td><%=e.getDescription()%></td>

												<td style='white-space: nowrap'><a
													class="btn btn-outline-info block" href="UpdateRapportUrgence.jsp?ID=<%=e.getId()%>"> Modifier </a> <a
													class="btn btn-outline-danger block"
													href="../supprimerRapportDurgence?code=<%=e.getId()%>">
														Supprimer </a></td>
											</tr>
											<%
												}
